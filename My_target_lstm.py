...
class TARGET_LSTM(object):
    def __init__(self, num_emb, batch_size, emb_dim, hidden_dim, sequence_length, start_token, params):
        ...
        with tf.variable_scope('generator'):
            self.g_embeddings = tf.Variable((tf.random_normal((10000, 32))))
    ...
    def create_recurrent_unit(self):
        ...
        self.Wi = tf.Variable(tf.random_normal((32, 32)))
        self.Ui = tf.Variable(tf.random_normal((32, 32)))
        self.bi = tf.Variable(tf.random_normal((32,)))

        self.Wf = tf.Variable((tf.random_normal((32, 32))))
        self.Uf = tf.Variable((tf.random_normal((32, 32))))
        self.bf = tf.Variable((tf.random_normal((32,))))

        self.Wog = tf.Variable((tf.random_normal((32, 32))))
        self.Uog = tf.Variable((tf.random_normal((32, 32))))
        self.bog = tf.Variable((tf.random_normal((32,))))

        self.Wc = tf.Variable((tf.random_normal((32, 32))))
        self.Uc = tf.Variable((tf.random_normal((32, 32))))
        self.bc = tf.Variable((tf.random_normal((32,))))
    ...
    def create_output_unit(self):
        self.Wo = tf.Variable(tf.random_normal((32, 10000)))
        self.bo = tf.Variable(tf.random_normal((10000,)))
